...
public class ManageOrganizationJPanel extends javax.swing.JPanel {
    ...
    private void populateCombo() {
        ...
        for (Type orgType : enterprise.getTypesOfOrganizations()) {
    ...
    private void populateTable() {
        ...
        for (Organization organization : directory.getOrganizationsDirectory()) {
    ...
    private void initComponents() {
        ...
        organizationJTable.setBackground(new java.awt.Color(102, 102, 0));
        ...
        addJButton.setBackground(new java.awt.Color(102, 102, 0));
        ...
        btnDeleteOrg.setBackground(new java.awt.Color(102, 102, 0));
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/account1.png"))); // NOI18N
    ...
    private void btnDeleteOrgActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteOrgActionPerformed
        ...
        if (selectedRow < 0) {
            ...
            enterprise.getOrganizationDirectory().getOrganizationsDirectory().remove(organization);
            populateTable();
        }
