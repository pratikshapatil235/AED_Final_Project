...
public class AllInsuranceRequestsJPanel extends javax.swing.JPanel {
    ...
    public AllInsuranceRequestsJPanel(JPanel userProcessContainer, User userAccount, Enterprise enterprise, InsuranceAgentOrganization insuranceAgentOrganization) {
        initComponents();
    ...
    private void initComponents() {
        ...
        tblInsuranceWorkTable.setBackground(new java.awt.Color(102, 102, 0));
        tblInsuranceWorkTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "PolicyNumber", "Paw Name", "Health Center", "Sender ", "Receiver Agent", "Billing Amount", "Claim Amount", "Status"
            }
        ) {
        ...
        btnProcessRequest.setBackground(new java.awt.Color(102, 102, 0));
    ...
    public void populateTable() {
        ...
        for (TaskRequest request : insuranceAgentOrganization.getWorkQueue().getWorkRequests()) {
