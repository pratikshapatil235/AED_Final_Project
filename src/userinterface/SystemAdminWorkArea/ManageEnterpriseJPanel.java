...
public class ManageEnterpriseJPanel extends javax.swing.JPanel {
     ...
     */
    public ManageEnterpriseJPanel(JPanel userProcessContainer, PawcareSystem system) {
        initComponents();
    ...
    private void initComponents() {
        ...
        btnDelete2.setBackground(new java.awt.Color(102, 102, 0));
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/doggo.gif"))); // NOI18N
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                .addGap(214, 214, 214)
                                .addComponent(btnDelete2, javax.swing.GroupLayout.PREFERRED_SIZE, 98, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(layout.createSequentialGroup()
                                .addGap(50, 50, 50)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
    ...
    private void submitJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitJButtonActionPerformed
        ...
        if (network == null || type == null) {
            ...
            if (names.contains(enterpriseName)) {
                JOptionPane.showMessageDialog(null, "Enterprise exists Already!!", "Warning!", JOptionPane.WARNING_MESSAGE);
                return;
            } else {
    ...
    private void btnDelete2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDelete2ActionPerformed
        ...
        if (selectedRow < 0) {
            ...
            int dialogResult = JOptionPane.showConfirmDialog(null, "Are you sure to proceed further?");
