...
public class EmailBillingInformationToPawPatient extends javax.swing.JPanel {

    JPanel userPrcessContainer;
    private AccountantBillingRequest accountBillingRequest;

    EmailBillingInformationToPawPatient(JPanel userProcessContainer, AccountantBillingRequest accountBillingRequest) {
        initComponents();
    ...
    private void initComponents() {
        ...
        btnSendEmail.setBackground(new java.awt.Color(102, 102, 0));
        ...
        btnClearText.setBackground(new java.awt.Color(102, 102, 0));
    ...
    private void SendMail(String toMail, String text) {
        String to = toMail;
        String from = "patil.pratiksha3333@gmail.com";
        ...
        Session session = Session.getDefaultInstance(properties, new javax.mail.Authenticator() {
            protected javax.mail.PasswordAuthentication getPasswordAuthentication() {
                return new javax.mail.PasswordAuthentication("patil.pratiksha3333@gmail.com", 
                        "ygfiqnrhurmrxeex");
            }
        });
        ...
        try {
            ...
            message.setSubject("Paw Patient Billing Details");
