...
public class AccountantProcessRequestJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Treatment Billing");
    ...
    private void btnSendRequestForInsuranceActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSendRequestForInsuranceActionPerformed
        ...
        PawInsuranceEnterprise matchedInsuranceCompany = null;
        ...
        for (Network network : networks) {
            ...
            for (Enterprise enterprise : enterprises) {
                if (enterprise.getName().equalsIgnoreCase(accountBillingRequest.getPatient().getInsuranceCustomer().getInsurance().getInsuranceCompany())) {
                    matchedInsuranceCompany = (PawInsuranceEnterprise) enterprise;
                }
            }
        }

        for (Organization organization : matchedInsuranceCompany.getOrganizationDirectory().getOrganizationsDirectory()) {
        ...
        if (org != null) {
            ...
            JOptionPane.showMessageDialog(null, "Money received from Dog's Owner: " + String.format("%.2f", String.valueOf(payableAmount)) + ". Insurance Claim Request Raised Successfully for amount:" + claimAmount);
